...
f0 = array([[complex(0,0) for a in range(0,40)] for b in range(1,40)])
f1 = array([[complex(0,0) for a in range(0,40)] for b in range(1,40)])
V = array([[complex(0,0) for a in range(0,40)] for b in range(1,40)])
